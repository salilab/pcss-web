...
#$ -S /bin/tcsh
#$ -cwd
#$  -o output.txt -e error.txt -l netappsali=1G,database=1G,scratch=1G -l arch=lx24-amd64 -r y -j y  -l mem_free=1G -l h_rt=24:00:00 -p 0 -t 1-3
...
set tasks=( seq_batch_1 seq_batch_2 seq_batch_3 )
set input=$tasks[$SGE_TASK_ID]

set HOME_RUN_DIR="/tmp/tmpHOz-lR" 
